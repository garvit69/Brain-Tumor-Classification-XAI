# -*- coding: utf-8 -*-
"""desnet_1_braintumor.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GYzzbmRGMnSSzMljjspWjwT9AUSBkI0f
"""
...
Class1_images = os.listdir(data_path + "/1")
Class2_images = os.listdir(data_path + "/2")
Class3_images = os.listdir(data_path + "/3")

Nos_Train = len(Class1_images) + len(Class2_images) + len(Class3_images)
...
train_datagen = ImageDataGenerator(rescale=1. / 255,
                                   ...
                                   validation_split=0.2) # for splitting the data into train and validation
...
validation_set = train_datagen.flow_from_directory(data_path, # same directory as training data
                                                   target_size=(image_size, image_size),
                                                   batch_size=BATCH_SIZE,
                                                   class_mode='categorical',
                                                   shuffle=False,
